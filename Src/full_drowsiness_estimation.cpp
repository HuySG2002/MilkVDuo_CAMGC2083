...
int main(int argc, const char** argv)
{
    ...
    VideoCapture capture("/home/hyuuuan/Documents/Drowsiness/drowsiness_detection/src/sample_videos/driver_day.mp4");
    if (!capture.isOpened())
    {
    ...
    while (capture.read(frame))
    {
        ...
        if (eyeOutput.eye_frame.empty()) {
            ...
            noFaceFrameCount = 0;  // Reset nếu phát hiện được gương mặt
            ...
            // Nếu một trong các điều kiện vượt ngưỡng → cảnh báo
